...
# Android 로 내보낸 대화내용을 dataframe에 넣기 
# 차트 표현하기(plot) _ 시간대별/일별 은 매개변수로 넣기 

# 시간대별 사용량 
def show_daily_usage(file_name, file_ver):
 #hours = []
    hour = ''
    # for i in range(24):
    #     hours.append(i)
...
if __name__ == '__main__':
    ...
    while(True):
        if(user_input == '1'):
            show_daily_usage(file_name, file_ver)
        elif (user_input == '2'):
